...
(def a-vacation (create-event  (->date "2015-12-25T09:16:00-07:00") (->date "2015-12-31T11:37:00-07:00") "Homer Vacation" :unique-id "1234" :description "During the last week of the year, it is traditional to go on vacation for Homer and his family. This year they will be going to Santa Fe, New Mexico." :url "http://www.example.com/1234" :location "1313 Mockingbird Lane" :organizer "http://www.example.com"))

(def an-all-day-event (create-all-day-event  (->date "2015-12-25T09:16:00-07:00")  "Homer Vacation" :unique-id "1234" :description "During the last week of the year, it is traditional to go on vacation for Homer and his family. This year they will be going to Santa Fe, New Mexico." :url "http://www.example.com/1234" :location "1313 Mockingbird Lane" :organizer "http://www.example.com"))

(def an-event-with-no-duration (create-event-no-duration  (->date "2015-12-25T09:16:00-07:00")  "Christmas party" :unique-id "1234" :description "This is the description" :url "http://www.example.com/1234" :location "this is the location" :organizer "http://www.example.com"))
